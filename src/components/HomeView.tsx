...
export default function HomeView({ setActiveTab, openQuoteModal }: HomeViewProps) {
  ...
  return (
    ...
    <section 
        id="hero-section" 
        className="relative min-h-[100dvh] flex flex-col bg-[#0b1b3d] overflow-hidden"
      >
        {/* Full-screen Background Image with Solar Panels on the Right */}
        <div className="absolute inset-0 z-0">
          <img
            ...
            // object-right ensures the house/panels stay on the right side of the screen
            className="w-full h-full object-cover object-right"
          />
          
          {/* Overlays for perfect blending and text readability */}
          {/* 1. Base dark tint */}
          <div className="absolute inset-0 bg-[#061024]/40"></div>
          {/* 2. Strong gradient from left (dark) to right (transparent) so text is readable */}
          <div className="absolute inset-0 bg-gradient-to-r from-[#0b1b3d] via-[#0b1b3d]/90 md:via-[#0b1b3d]/70 to-transparent"></div>
          {/* 3. Bottom gradient to blend smoothly with the next section */}
          <div className="absolute inset-0 bg-gradient-to-t from-[#0b1b3d] via-transparent to-transparent"></div>
        </div>

        {/* Main Content Container */}
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-24 lg:pt-32 pb-8 flex-grow flex flex-col justify-start sm:justify-center mt-6 sm:mt-0">
          <div className="max-w-2xl space-y-4 sm:space-y-6">
            
            {/* Eyebrow Text */}
            <div className="flex items-center space-x-3 sm:space-x-4">
              <div className="h-[1px] w-6 sm:w-8 bg-emerald-500"></div>
              <span className="text-emerald-400 text-[10px] sm:text-xs font-semibold uppercase tracking-[0.2em]">
                We're launching soon
              </span>
            </div>

            {/* Responsive Heading */}
            <h1 className="text-[2.75rem] sm:text-6xl lg:text-7xl font-medium text-white tracking-tight leading-[1.05] font-display">
              Something <br />
              <span className="text-emerald-400">Big Is Coming</span> <br />
              Soon
            </h1>

            {/* Subtitle */}
            <p className="text-white/75 text-sm sm:text-base leading-relaxed max-w-sm pt-1 sm:pt-2">
              Advanced solar solutions for a cleaner, greener and brighter tomorrow.
            </p>

            {/* Call to Action Buttons */}
            <div className="flex flex-col sm:flex-row gap-3.5 sm:gap-4 pt-5 sm:pt-6 w-full sm:w-auto" id="hero-actions">
              <button
                type="button"
                id="hero-quote-btn"
                onClick={openQuoteModal}
                className="w-full sm:w-auto bg-emerald-600 hover:bg-emerald-500 text-white font-extrabold py-3.5 px-8 rounded-full shadow-lg shadow-emerald-900/50 hover:-translate-y-0.5 transition-all duration-300 text-sm tracking-wide flex justify-center items-center"
              >
                Get Free Quote
              </button>
              <button
                ...
                className="w-full sm:w-auto bg-transparent hover:bg-white/10 backdrop-blur-sm border border-white/30 text-white font-extrabold py-3.5 px-8 rounded-full hover:-translate-y-0.5 transition-all duration-300 text-sm tracking-wide flex justify-center items-center space-x-2"
              >
            ...
            {/* 4-Icon Feature Grid */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 pt-10 sm:pt-14 mt-2 sm:mt-4">
              <div className="flex flex-col space-y-2.5 sm:space-y-3">
                <Leaf className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-400" strokeWidth={1.5} />
                <span className="text-[9px] sm:text-[10px] font-bold text-white/70 uppercase tracking-widest leading-relaxed">
                  Solar Panel<br />Installation
                </span>
              </div>
              <div className="flex flex-col space-y-2.5 sm:space-y-3">
                <Zap className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-400" strokeWidth={1.5} />
                <span className="text-[9px] sm:text-[10px] font-bold text-white/70 uppercase tracking-widest leading-relaxed">
                  Energy Storage<br />Solutions
                </span>
              </div>
              <div className="flex flex-col space-y-2.5 sm:space-y-3">
                <Home className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-400" strokeWidth={1.5} />
                <span className="text-[9px] sm:text-[10px] font-bold text-white/70 uppercase tracking-widest leading-relaxed">
                  Residential &<br />Commercial
                </span>
              </div>
              <div className="flex flex-col space-y-2.5 sm:space-y-3">
                <Globe className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-400" strokeWidth={1.5} />
                <span className="text-[9px] sm:text-[10px] font-bold text-white/70 uppercase tracking-widest leading-relaxed">
        ...
        {/* Footer / Scroll & Socials */}
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-6 sm:pb-8 pt-4 flex justify-center items-end mt-auto">
          
          {/* Scroll Indicator */}
          <div className="flex items-center space-x-3 sm:space-x-4 text-white/60 hover:text-white transition-colors cursor-pointer">
            <div className="w-5 h-8 sm:w-6 sm:h-10 rounded-full border-2 border-white/40 flex justify-center pt-1.5 sm:pt-2">
              <motion.div 
                animate={{ y: [0, 6, 0] }}
            ...
            <span className="text-[9px] sm:text-[10px] md:text-xs font-bold uppercase tracking-[0.2em]">Scroll to explore</span>
          </div>
        </div>
      </section>
